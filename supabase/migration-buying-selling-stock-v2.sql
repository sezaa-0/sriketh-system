...
set
  ...
  buying_weight = case when coalesce(buying_weight, 0) = 0 then coalesce(nullif(total_kg, 0), buying_weight_kg, 0) else buying_weight end,
  selling_weight = case when coalesce(selling_weight, 0) = 0 then coalesce(nullif(total_kg, 0), buying_weight_kg, 0) else selling_weight end,
